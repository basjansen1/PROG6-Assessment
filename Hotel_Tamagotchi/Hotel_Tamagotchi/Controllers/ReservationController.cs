...
namespace Hotel_Tamagotchi.Controllers
{
    public class ReservationController : Controller
    {
        ...
        public void Complete(RoomViewModel roomViewModel)
        {
            ...
            List<Tamagotchi> SelectedTamagotchiList = _detailsRoomVM.Tamagotichis.Select(t => _tamagotchiRepository.Get(t.ID)).ToList(); // test
            //room.TamagotchiList = SelectedTamagotchiList; 
            //SelectedTamagotchiList.ForEach(t => _tamagotchiRepository.Update(t)); //hoeft in principe niet
            SelectedTamagotchiList.ForEach(t => t.CurrentRoom = room);
            SelectedTamagotchiList.ForEach(t => _tamagotchiRepository.Update(t));
